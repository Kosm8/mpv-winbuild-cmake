...
elseif(COMPILER_TOOLCHAIN STREQUAL "clang")
    ...
    set(opt "-O3 -mllvm --polly -mllvm --polly-position=before-vectorizer -mllvm --polly-ast-use-context -mllvm --polly-vectorizer=stripmine -mllvm --polly-run-dce -mllvm --polly-invariant-load-hoisting -mllvm --polly-run-inliner -Wl,-O3,-mllvm,--polly,-mllvm,--polly-position=before-vectorizer,-mllvm,--polly-ast-use-context,-mllvm,--polly-vectorizer=stripmine,-mllvm,--polly-run-dce,-mllvm,--polly-invariant-load-hoisting,-mllvm,--polly-run-inliner")
endif()
